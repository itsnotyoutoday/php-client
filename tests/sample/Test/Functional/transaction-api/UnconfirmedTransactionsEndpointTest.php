...
/**
 * Class UnconfirmedTransactionsEndpointTest
 * @package sample\Test\Functional\transaction
 */
class UnconfirmedTransactionsEndpointTest extends WebTestCase
{
    ...
    public function testUnconfirmedTransactionsEndpoint()
    {
