...
/**
 * Class CreateAndSignAndSendTransactionTest
 * @package sample\Test\Functional\transaction
 */
class CreateAndSignAndSendTransactionTest extends WebTestCase
{
    ...
    public function testCreateAndSignAndSendTransaction()
    {
