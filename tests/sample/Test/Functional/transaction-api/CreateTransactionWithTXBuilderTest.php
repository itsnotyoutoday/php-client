...
/**
 * Class CreateTransactionWithTXBuilderTest
 * @package sample\Test\Functional\transaction
 */
class CreateTransactionWithTXBuilderTest extends WebTestCase
{
    ...
    public function testCreateTransactionWithTXBuilder()
    {
