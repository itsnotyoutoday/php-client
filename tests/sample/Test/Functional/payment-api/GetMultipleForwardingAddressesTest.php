...
/**
 * Class GetMultipleForwardingAddressesTest
 * @package sample\Test\Functional\transaction
 */
class GetMultipleForwardingAddressesTest extends WebTestCase
{
    ...
    public function testGetMultipleForwardingAddresses()
    {
