...
/**
 * Class CreateMicroTXFromPubkeyDocsSampleTest
 * @package sample\Test\Functional\transaction
 */
class CreateMicroTXFromPubkeyDocsSampleTest extends WebTestCase
{
    ...
    public function testCreateMicroTXFromPubkeyDocsSample()
    {
