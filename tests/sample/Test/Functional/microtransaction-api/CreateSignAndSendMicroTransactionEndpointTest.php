...
/**
 * Class CreateSignAndSendMicroTransactionEndpointTest
 * @package sample\Test\Functional\transaction
 */
class CreateSignAndSendMicroTransactionEndpointTest extends WebTestCase
{
    ...
    public function testCreateSignAndSendMicroTransactionEndpoint()
    {
