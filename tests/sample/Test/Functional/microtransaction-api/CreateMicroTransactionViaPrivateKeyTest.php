...
/**
 * Class CreateMicroTransactionViaPrivateKeyTest
 * @package sample\Test\Functional\transaction
 */
class CreateMicroTransactionViaPrivateKeyTest extends WebTestCase
{
    ...
    public function testCreateMicroTransactionViaPrivateKey()
    {
