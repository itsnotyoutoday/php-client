...
/**
 * Class CreateMicroTXWithMicroTXBuilderTest
 * @package sample\Test\Functional\transaction
 */
class CreateMicroTXWithMicroTXBuilderTest extends WebTestCase
{
    ...
    public function testCreateMicroTXWithMicroTXBuilder()
    {
