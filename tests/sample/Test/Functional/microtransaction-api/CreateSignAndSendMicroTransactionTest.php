...
/**
 * Class CreateSignAndSendMicroTransactionTest
 * @package sample\Test\Functional\transaction
 */
class CreateSignAndSendMicroTransactionTest extends WebTestCase
{
    ...
    public function testCreateSignAndSendMicroTransaction()
    {
