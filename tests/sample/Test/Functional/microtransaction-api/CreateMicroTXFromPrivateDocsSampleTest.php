...
/**
 * Class CreateMicroTXFromPrivateDocsSampleTest
 * @package sample\Test\Functional\transaction
 */
class CreateMicroTXFromPrivateDocsSampleTest extends WebTestCase
{
    ...
    public function testCreateMicroTXFromPrivateDocsSample()
    {
