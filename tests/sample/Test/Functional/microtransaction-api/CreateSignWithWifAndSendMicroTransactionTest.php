...
/**
 * Class CreateSignWithWifAndSendMicroTransactionTest
 * @package sample\Test\Functional\transaction
 */
class CreateSignWithWifAndSendMicroTransactionTest extends WebTestCase
{
    ...
    public function testCreateSignWithWifAndSendMicroTransaction()
    {
